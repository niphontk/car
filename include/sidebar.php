...
$arr_settings = array("driver","driver/delete","system","category","category/delete","place","place/delete","type","type/delete","brand","brand/delete","inventory", "inventory/add","inventory/edit","inventory/delete","status","status/delete","problem", "problem/delete", "language","department","department/delete","users","users/add","users/edit", "users/delete");
$arr_category = array("category","category/delete");
$arr_driver = array("driver","driver/delete");
$arr_place = array("place","place/delete");
...
$arr_department = array("department","department/delete");
$arr_report = array("report01");
$arr_report01 = array("report01");
$arr_usecar = array("usecar","usecar/add","usecar/edit","usecar/delete");
  ...
  <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="?page=usecar" class="nav-link <?php if(in_array($page, $arr_usecar)){echo "active"; }?>">
            <i class="nav-icon fas fa-clipboard-list"></i>
            <p>
            <?php lang("UseCar");?>
            </p>
        ...
        <li class="nav-item has-treeview <?php if(in_array($page, $arr_settings)){echo "menu-open"; }?>">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="?page=department" class="nav-link <?php if(in_array($page, $arr_department)){echo "active"; }?>">
                <i class="far fa-circle nav-icon"></i>
                <p><?php lang("department");?></p>
              </a>
            </li>  
            <li class="nav-item">
              <a href="?page=place" class="nav-link <?php if(in_array($page, $arr_place)){echo "active"; }?>">
                <i class="far fa-circle nav-icon"></i>
                <p><?php lang("RepairPlace");?></p>
              </a>
            </li>     
            <li class="nav-item">
              <a href="?page=driver" class="nav-link <?php if(in_array($page, $arr_driver)){echo "active"; }?>">
                <i class="far fa-circle nav-icon"></i>
                <p><?php lang("Driver");?></p>
              </a>
            </li>            
