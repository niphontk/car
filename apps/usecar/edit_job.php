            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="info">
                  <form id="forminfo" class="form-horizontal" action="apps/repair/do_repair.php?action=update_repair_job&repair_id=<?php echo $repair["id"];?>"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select name="inven" id="inven" class="form-control select2bs4 select2-hidden-accessible" <?php echo $disabled;?> style="width: 100%;" tabindex="-1" aria-hidden="true">
                        ...
                        ?>
                          <option value="<?php echo $v["id"];?>" <?php if($repair["inventory_id"] == $v["id"]){echo "selected";}?>><?php echo $v["name"];?>[เลขทะเบียน : <?php echo $v["serial_number"];?>]</option>
                        <?php } ?>
                      </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="Description" class="col-sm-2 col-form-label"> <?php lang("JobDetail");?> <span
                      class="text-danger">*</span></label>
                  <div class="col-sm-10">
                    <textarea name="jobdetail" id="Jobdetail"rows="5" class="form-control" > <?php echo $repair["jobdetail"];?></textarea>
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <select name="technician" id="technician" class="form-control">
                        ...
                        <?php
                          foreach($users as $v){
                        ?>
                          <option value="<?php echo $v["id"];?>" <?php if($v["id"] == $repair["technician"]){echo "selected";}?>><?php echo $v["name"];?></option>
                        <?php } ?>
                      </select>
                  </div>
                </div>
                ...
                <?php if($_SESSION["POSITION"] == "1" || $_SESSION["POSITION"] == "3"){?>
                    <div class="form-group row">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="apps/repair/do_repair.php?action=created_detail_job" method="POST">
