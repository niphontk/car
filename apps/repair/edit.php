            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="info">
                  <form id="forminfo" class="form-horizontal" action="apps/repair/do_repair.php?action=update_repair&repair_id=<?php echo $repair["id"];?>"
                    method="POST" autocomplete="off">
                    <input type="hidden" id="repair_id" name="repair_id" value="<?php echo $repair["id"];?>">
                   
                <div class="form-group row">
                  <label for="inven" class="col-sm-2 col-form-label"><?php lang("Inventory1");?> <span class="text-danger">*</span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label for="technician" class="col-sm-2 col-form-label"><?php lang("RepairPlace");?> <span class="text-danger">*</span></label>
                  <div class="col-sm-10">
                    <select name="technician" id="technician" class="form-control">
                        <option value="">-- <?php lang("Please Select RepairPlace");?> --</option>
                        <?php
                          foreach($users as $v){
                        ?>
