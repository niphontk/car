...
$('#modalDelete').on('show.bs.modal', function (event) {
  ...
  $('#modalEndjob').on('show.bs.modal', function (event) {
    var button = $(event.relatedTarget)
    var inven_id = button.data('inven-id')
    var repairname = button.data('repairname')
    var modal = $(this)
    modal.find('.modal-body span').text(alert_endjob_modal)

    $("#modalEndjob .btn-continue").off();
    $("#modalEndjob .btn-continue").on("click", function(){
        window.location.href="apps/repair/do_repair.php?action=endjob&inven_id="+inven_id;
    })
  })
