<?php
  ...
  if($_SESSION["POSITION"] == "3"){
    $conditions = " WHERE `technician` = '".$_SESSION["USER_ID"]."' order by created_at desc";
  }else{
              ...
              <form action="apps/repair/do_repair.php?action=delete_all" id="frm" method="POST">
                ...
                ?>
                      <tr>
                        ...
                        <td><?php echo isset($place_txt[$repair["technician"]]) ? $place_txt[$repair["technician"]] : "-";?></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              ...
                              <?php }else{ ?>
                                <small><a class="dropdown-item"
                                  href="?page=repair/edit_job&repair_id=<?php echo $repair["id"];?>"><i class="fas fa-edit"></i>
                                  <?php lang("Edit");?></a></small>
                              <?php } ?>
                              <small><a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                  data-target="#modalEndjob" data-inven-id="<?php echo $repair["inventory_id"];?>"
                                  data-repairname="<?php echo $repair["title"];?>"
                                  ><i class="fas fa-edit"></i>
                                  <?php lang("EndJob");?></a></small>
                              <small><a class="dropdown-item"
...
<div class="modal" id="modalEndjob" role="dialog" tabindex="-1" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <i class="fas fa-exclamation-circle"></i>
...
<script type="text/javascript">
  ...
  var alert_endjob_modal = "<?php lang("Are you want to send job?");?>";
</script>
