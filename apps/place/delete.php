      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="?page=place"><?php lang("RepairPlace");?></a></li>
            ...
            <div class="card-body">
                ...
                ?>
                      <tr>
                        ...
                        <a href="apps/place/do_place.php?action=cancel_delete&place_id=<?php echo $row["id"];?>" class="btn btn-primary btn-sm" ><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
