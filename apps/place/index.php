...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><?php lang("RepairPlace");?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./"><?php lang("Home");?></a></li>
            <li class="breadcrumb-item active"><?php lang("RepairPlace");?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="border border-secondary p-3 mb-4">
              <form id="forminfo" action="apps/place/do_place.php?action=save_category" method="POST" autocomplete="off">
                <div class="row d-flex justify-content-center">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="text" name="place_name" id="place_name" class="form-control form-control-sm" placeholder="<?php lang("RepairPlace");?> *">
              ...
              <form action="apps/place/do_place.php?action=delete_all" id="frm" method="POST">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small><a class="dropdown-item place-edit"
                                  href="javascript:void(0);" data-place-id="<?php echo  $category["id"];?>" data-place-is-active="<?php echo $category["is_active"];?>" data-place-name="<?php echo $category["name"];?>"><i class="fas fa-edit"></i>
                                  <?php lang("Edit");?></a></small>
                              <small><a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                  data-target="#modalDelete" data-place-id="<?php echo $category["id"];?>" data-place-name="<?php echo $category["name"];?>"><i class="fas fa-minus-circle"></i>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="btn-group">
                      ...
                      <a href="?page=place/delete" class="btn-sm btn btn-info"><i class="fas fa-trash"></i>
                      <?php lang("Trash");?></a>
                    </div>
                  </div>
                </div>
