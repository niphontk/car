...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><?php lang("Driver");?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./"><?php lang("Home");?></a></li>
            <li class="breadcrumb-item"><a href="?page=category"><?php lang("Driver");?></a></li>
                ...
                ?>
                      <tr>
                        ...
                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                  data-target="#modalDelete" data-driver-id="<?php echo $row["id"];?>" data-driver-name="<?php echo $row["name"];?>"><i class="fas fa-trash"></i></button>
                        <a href="apps/driver/do_driver.php?action=cancel_delete&driver_id=<?php echo $row["id"];?>" class="btn btn-primary btn-sm" ><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
