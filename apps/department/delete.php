      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="?page=department"><?php lang("department");?></a></li>
                ...
                ?>
                      <tr>
                        ...
                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                  data-target="#modalDelete" data-depart-id="<?php echo $row["id"];?>" data-depart-name="<?php echo $row["depart_name"];?>"><i class="fas fa-trash"></i></button>
                        <a href="apps/department/do_department.php?action=cancel_delete&depart_id=<?php echo $row["id"];?>" class="btn btn-primary btn-sm" ><i class="fas fa-times"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
