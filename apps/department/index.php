...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><?php lang("department");?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./"><?php lang("Home");?></a></li>
            <li class="breadcrumb-item active"><?php lang("department");?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card">            
            <div class="card-body">
              <div class="border border-secondary p-3 mb-4">
                <form id="forminfo" action="apps/department/do_department.php?action=save_depart" method="POST"
                  autocomplete="off">
                      ...
                      <div class="form-group">
                        <div class="custom-control custom-switch custom-switch-on-success">
                          <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="Y"
                            checked>
                          <label class="custom-control-label" for="is_active"><?php lang("Enabled");?>/<?php lang("Close");?></label>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <input type="text" name="depart_name" id="depart_name" class="form-control form-control-sm"
              ...
              <form action="apps/department/do_department.php?action=delete_all" id="frm" method="POST">
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <small><a class="dropdown-item status-edit" href="javascript:void(0);"
                                  data-depart-id="<?php echo $row["id"];?>" data-depart-is-active="<?php echo $row["is_active"];?>"
                                  data-depart-name="<?php echo $row["depart_name"];?>" ><i class="fas fa-edit"></i>
                                  <?php lang("Edit");?></a></small>
                              <small><a class="dropdown-item" href="javascript:void(0);" data-toggle="modal"
                                  data-target="#modalDelete" data-depart-id="<?php echo $row["id"];?>"
                                  data-depart-name="<?php echo $row["depart_name"];?>"><i class="fas fa-minus-circle"></i>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="btn-group">
                      ...
                      <a href="?page=department/delete" class="btn-sm btn btn-info"><i class="fas fa-trash"></i>
                      <?php lang("Trash");?></a>
                    </div>
                  </div>
                </div>
