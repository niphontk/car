...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><?php lang("Car");?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./"><?php lang("Home");?></a></li>
            <li class="breadcrumb-item"><a href="?page=inventory"><?php lang("Car");?></a></li>
          ...
          <div class="card">
            <div class="card-body">
              <form id="forminfo" class="form-horizontal" enctype="multipart/form-data"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-9 col-lg-3">
                    ...
                    <select name="is_active" id="is_active" class="form-control">
                      ...
                      <option value="N" <?php if($inventory["is_active"] == "N"){ echo "selected";}?>><?php lang("Disabled");?></option>
                ...
                <div class="form-group row">
                  <label for="name" class="col-sm-2 col-form-label"><?php lang("Number");?> <span class="text-danger">*</span></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_no" name="id_no" value="<?php echo $inventory["id_no"];?>" placeholder="<?php lang("Number");?>"
                      required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <label for="password" class="col-sm-2 col-form-label"><?php lang("Id Number");?> <span
                      class="text-danger">*</span></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="id_number" name="id_number" value="<?php echo $inventory["id_number"];?>"
