<?php
  ...
  $fields = "*";
  $table = "inventory";
  $conditions = " WHERE `is_delete` = 'N' AND `is_active` = '$isactive' ";
  ...
  foreach($departments as $department){
    $depart_txt[$department["id"]] = $department["depart_name"];
  }
              ...
              <form action="apps/inventory/do_inventory.php?action=delete_all" id="frm" method="POST">
                ...
                ?>
                      <tr>
                        ...
                        <td><?php echo $row["name"];?>[<?php echo $row["id_number"];?>]</td>
                        <td><?php echo isset($depart_txt[$row["depart_id"]]) ? $depart_txt[$row["depart_id"]] : "";?></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              ...
                              <small><a class="dropdown-item"
                                  href="?page=inventory/history&inventory_id=<?php echo $row["id"];?>"><i class="fas fa-edit"></i>
                                  <?php lang("History");?></a></small>
                              
                              <small><a class="dropdown-item"
                                  href="?page=inventory/edit&inventory_id=<?php echo $row["id"];?>"><i class="fas fa-edit"></i>
                                  <?php lang("Mainternance");?></a></small>
