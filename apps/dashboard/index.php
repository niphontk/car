<?php
  ...
  $place = fetch_all("*","place");
  $place_txt = array();
  foreach($place as $place){
    $place_txt[$place["id"]] = $place["name"];    
  }
  
  $fields = "*";
  $table = "users";
  $conditions = " WHERE `is_delete` = 'N' ";
  if($_SESSION["POSITION"] == "1" || $_SESSION["POSITION"] == "3" || $_SESSION["POSITION"] == "4"){
    $conditions .= " AND `position` IN (4) ORDER BY `position` DESC  ";
  }
  ...
  $conditions = " WHERE `is_delete` = 'N' ";
  if($_SESSION["POSITION"] == "1" || $_SESSION["POSITION"] == "3" || $_SESSION["POSITION"] == "4"){
    $conditions .= " AND `position` IN (2) ORDER BY `position` DESC  ";
  }
  $users1 = fetch_all($fields, $table, $conditions);
  $count_users1 = count($users1); 
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            ...
            <a href="?page=inventoryby&isactive=Y" class="small-box-footer"><?php lang("View More");?> <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <a href="?page=inventoryby&isactive=N" class="small-box-footer"><?php lang("View More");?> <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-primary">
            ...
            <a href="?page=inventoryby&isactive=RP" class="small-box-footer"><?php lang("View More");?> <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="container-fluid">
                              ...
                              <div class="row">
                                <div class="col-md-4"><p><?php lang("title");?></p></div>
                                <div class="col-md-8"><p><?php echo $repair["title"]." ".$repair["description"];?></p></div>
                              </div>
                              <div class="row">
                                <div class="col-md-4"><p><?php lang("driver");?></p></div>
                                <div class="col-md-8"><p><?php echo isset($driver_txt[$repair["driver_id"]]) ? $driver_txt[$repair["driver_id"]] : "-";?></p></div>
                              </div>
                              <div class="row">
                                <div class="col-md-4"><p><?php lang("Status");?></p></div>
                                <div class="col-md-8"><p><?php echo isset($status_txt[$repair["approve"]]) ? $status_txt[$repair["approve"]] : "-";?></p></div>
                              </div>
                              <div class="row">
                                <div class="col-md-4"><p><?php lang("Note");?></p></div>
                                <div class="col-md-8"><p><?php echo $repair["description"];?></p></div>
                              </div>
                            </div>
                            </div>
